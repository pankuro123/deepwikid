...
export default function ProcessedProjects({
  ...
  return (
    <div className={`${className}`}>
      ...
      {maxItems && projects.length > maxItems && !searchQuery && (
        <div className="mt-8 flex justify-center">
          <Link
            href="/wiki/projects"
            className="px-6 py-2 rounded-full border border-[var(--accent-primary)] text-[var(--accent-primary)] hover:bg-[var(--accent-primary)] hover:text-white transition-all duration-200 font-medium flex items-center gap-2"
          >
